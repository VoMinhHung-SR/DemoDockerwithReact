...
const Header = () => {
  ...
  return (
    <header className="bg-white fixed top-0 w-full z-[999]">
      <nav
      ...
      >
        <div className="flex lg:flex-1">
          <Link to="/">
            <p className='-m-1.5 p-1.5 flex items-center'>
              <img
                  className="h-8 w-auto"
                  src="./logo.png"
                  alt="logo "
                />
              <span className='px-1 font-semibold'>HTheme</span>
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="##">
              <span className="sr-only">HTheme</span>
              <img
                className="h-8 w-auto"
                src="./logo.png"
                alt=""
